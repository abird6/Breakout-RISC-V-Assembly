...
# =================================== Test 6 Description ============================= #
# Test Number:				6
# Description:				Ball will miss paddle with one life remaining.
#                     Game over screen will show.
# =================================== End of Description ============================= #
...
testbench6:  
  ...
  addi  x18,  x0,   16    # CSBallXAdd (4:0)
  addi  x19,  x0,   16    # NSBallXAdd (4:0)
  addi  x20,  x0,   20    # CSBallYAdd (4:0)		(Address 20 = Row 5)	
  addi  x21,  x0,   20    # NSBallYAdd (4:0)		(Address 20 = Row 5)
  ...
  lui   x25,  0x0007c     # paddleVec 0b0000 0000 0000 0111 1100 0000 0000 0000 = 0x0007c000
  addi  x26,  x0,   5     # paddleSize
  addi  x27,  x0,   25    # paddleXAddLSB       - Paddle moved out of the way of ball in this test.
  addi  x28,  x0,   1     # paddleNumDlyCount 
...
testbench7:  
  ...
  # Wall
  # xori  x16,  x0,   -1    # wall x16 = 0xffffffff
  lui   x16,  0x00010     # matches ballVec 0b0000 0000 0000 0001 0000 0000 0000 0000 
...
# =================================== Test 8 Description ============================= #
# Test Number:				8
# Description:				Player reaches score of X
#                     The speed of the ball will double (to make game progressively 
#                     more challenging)
# =================================== End of Description ============================= #

# !!!!!!!!!!!!!!!!!!!!!!!! INCOMPLETE - Only template code in place !!!!!!!!!!!!!!!!!! # 
testbench8:  
	lui   x15,  0x98968     # 0x98968000 
  srli  x15,  x15,  9	    # 0x00098968 
  addi x15, x0, 2         # low count delay, for testing 
...
# =================================== Test 9 Description ============================= #
# Test Number:				9
# Description:				Bounce ball off the South (under) side of the fixed barriers (The bonus feature)
#                     Ball's Y direction will flip. Ball's X direction will not change
# =================================== End of Description ============================= #
...
testbench9:  
  ...
  addi  x21,  x0,   28    # NSBallYAdd (4:0)	(Address 28 = Row 7)
  addi  x20,  x0,   28    # CSBallYAdd (4:0)	(Address 28 = Row 7)	
  addi  x22,  x0,   5     # CSBallDir  (2:0) = 101 = NE
  addi  x23,  x0,   5 	  # NSBallDir  (2:0) = 101 = NE
  addi  x24,  x0,   1     # ballNumDlyCount (4:0)
...
# =================================== Test 10 Description ============================= #
# Test Number:				10
# Description:				Bounce ball off the east (right hand) side of the fixed barriers (The bonus feature)
#                     Ball's Y direction will be preserved. Ball's X direction will invert
# =================================== End of Description ============================= #
